...
async function multiTurnAgent(prompt: string, context: AgentContext): Promise<AgentResult> {
  ...
  if (turnNumber === 1) {
    output = 'I understand you want to create a greeting function. Here is the initial implementation:\n\nfunction greet(name) {\n  return "Hello, " + name;\n}';
  } else if (turnNumber === 2) {
    output = 'I have added TypeScript types to the function:\n\nfunction greet(name: string): string {\n  return "Hello, " + name;\n}';
  } else if (turnNumber === 3) {
    output = 'I have added JSDoc documentation:\n\n/**\n * Greets a person by name\n * @param name - The name of the person to greet\n * @returns A greeting message\n */\nfunction greet(name: string): string {\n  return "Hello, " + name;\n}';
  } else {
